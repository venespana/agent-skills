# React Performance — Eliminating Waterfalls (CRITICAL)

Adapted from Vercel React Best Practices. Waterfalls are the #1 performance killer: each sequential await adds full network latency.
