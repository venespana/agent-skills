# React Performance — Re-render Optimization Part 2 (MEDIUM)

Adapted from Vercel React Best Practices. Rules 5.9-5.15: hook splitting, functional setState, lazy init, transitions, deferred values, refs.
