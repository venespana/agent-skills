# React Performance — JavaScript Performance Part 2 (LOW-MEDIUM)

Adapted from Vercel React Best Practices. Rules 7.8-7.14: early length check, early return, RegExp hoisting, flatMap, min/max loop, Set/Map, toSorted.
