# React Performance — Rendering Performance Part 2 (MEDIUM)

Adapted from Vercel React Best Practices. Rules 6.8-6.11: script loading, conditional rendering, resource hints, useTransition loading.
